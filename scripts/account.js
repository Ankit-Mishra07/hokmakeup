...
if(localStorage.getItem("hok_users") === null) {
            localStorage.setItem("hok_users", JSON.stringify([]))
        }
...
function signup(event) {
        ...
        let array = JSON.parse(localStorage.getItem("hok_users"))
        ...
        localStorage.setItem("hok_users" , JSON.stringify(array))
   ...
   function loggin(event) {
        ...
        let email = document.getElementById("ankitemail")
        let password = document.getElementById("ankitpassword")
